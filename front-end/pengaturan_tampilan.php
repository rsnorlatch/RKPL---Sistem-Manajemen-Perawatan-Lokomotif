...
if (!empty($_SESSION['user_is_driver'])) {
    $st = 'driver_settings'; $fk = 'driver_id';
} elseif (!empty($_SESSION['user_is_maintainer'])) {
    $st = 'maintainer_settings'; $fk = 'maintainer_id';
} else {
    $st = 'central_office_settings'; $fk = 'central_office_id';
}
    ...
    <form action="../src/feature/setting/endpoint/save_theme.php" method="POST">
      <div class="radio-list">
        ...
        <label class="radio-row <?= $theme==='day' ? 'active' : '' ?>">
          <div class="row-icon">
            <svg viewBox="0 0 24 24"><path d="M6.76 4.84l-1.8-1.79-1.41 1.41 1.79 1.79zM4 10.5H1v2h3zm9-9.95h-2V3.5h2zM18.24 4.84l-1.42 1.41 1.8 1.79 1.41-1.41zM20 10.5v2h3v-2zm-8-5c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm-1 16.95h2V19.5h-2zm-7.45-3.91l1.41 1.41 1.79-1.8-1.41-1.41z"/></svg>
          </div>
